# AI IMAGE DETECTION IMAGE ANALYSIS APPLICATION - EXPRESSAPI
 Server Side of the Full Stack Image Detection Application.
 ## 🛠 Client Side Repository
<a href="https://github.com/vargaae/ai-2025" target="_blank"> ReactJS Application on the client side</a>
...
This application analyses the loaded image and makes predictions of concepts, that we can use for example for keywords. 
</p>
